...
| `:regelsuche-math-algorithms` | `de.regelsuche.math.algorithms` | Reine Java-Implementierungen (Gröbner-Style-Polynomnormalformen, Knuth-Bendix/Critical-Pairs, PSLQ-ähnliche numerische Relationssuche) | `:regelsuche-core`, `:regelsuche-validation` |
| `:regelsuche-math-jas` | `de.regelsuche.math.jas` | Optional isolierte Adapter-Schicht für JAS/Singular-nahe Backends (default: nicht aktiv) | `:regelsuche-validation` |
