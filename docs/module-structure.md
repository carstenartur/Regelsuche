...
| `:regelsuche-validation` | `de.regelsuche.equivalence`, `validation` | Äquivalenzchecks, Gegenbeispiel-/Validierungsports, Registry/Ports für mathematische Algorithmen ohne GraalVM- oder Datenbankabhängigkeiten | `:regelsuche-core` |
