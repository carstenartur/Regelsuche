...
| einen Release durchführen oder nachträglich prüfen | [Release-Betrieb](release-operations.md) und [Audit eines veröffentlichten Releases](published-release-audit.md) |
...
- [Audit eines veröffentlichten Releases](published-release-audit.md) —
  unabhängiger Download, Hash-/Tag-/Manifestprüfung, Produkt-Smoketests und
  Zenodo-Abgleich.
