...
`regelsuche.interestingness-profile-calibration/v1` vergleicht die beiden v1-Profile auf denselben Rohkomponenten.
...
6. Agreement, TEST-Ranking und Sensitivität verwenden dieselbe Eligibility-first-Ordnung; ein vollständiger Kandidat kann nicht durch einen unvollständigen Kandidaten mit höherem Rohscore überholt werden.
