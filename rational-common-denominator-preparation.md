...
assumptions. Replay intentionally preserves the existing operator's formatted
condition even for a composite denominator consisting only of numeric factors;
for example, `2 * 3 != 0` remains explicit although mechanically redundant.
