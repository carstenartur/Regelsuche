...
extractor = Path('/workspace/scratch/6b23a1484cae/ai-trend-diagnosis/ai-knowledge-extractor')
init_script = Path('/workspace/scratch/6b23a1484cae/ai-trend-diagnosis/java25-extractor.init.gradle')
java_home = Path('/workspace/scratch/fcfe4cbdbc35/runtime/jdk-25.0.2+10')
