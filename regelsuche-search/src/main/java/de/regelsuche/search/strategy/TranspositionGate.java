...
public final class TranspositionGate {
    ...
    /**
     * Evaluate a candidate state against the {@link SearchMemory}. The state is
     * looked up and recorded under its current canonical identity only.
     *
     * <ul>
     *   <li>Returns {@link Verdict#KEEP KEEP} for first sightings, states with
     *       strictly better score, states reached at lower depth, or states whose
     *       applied rule set adds at least one previously unseen rule id.</li>
     *   <li>Otherwise returns {@link Verdict#PRUNE PRUNE} and emits a matching
     *       {@link PruningDecision}.</li>
     * </ul>
     *
