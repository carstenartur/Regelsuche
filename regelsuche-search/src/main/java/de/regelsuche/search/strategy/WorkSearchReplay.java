...
public final class WorkSearchReplay {
    ...
    public static Result verify(String expectedCanonicalJson, Problem independentlyVerifiedProblem) {
        return verify(expectedCanonicalJson, independentlyVerifiedProblem, de.regelsuche.scoring.ScoreRevision.CURRENT);
    }

    public static Result verify(String expectedCanonicalJson, Problem independentlyVerifiedProblem,
            String expectedScoringRevision) {
        Objects.requireNonNull(expectedCanonicalJson, "expectedCanonicalJson");
        de.regelsuche.scoring.ScoreRevision.requireReplay(expectedCanonicalJson, SCHEMA, expectedScoringRevision);
