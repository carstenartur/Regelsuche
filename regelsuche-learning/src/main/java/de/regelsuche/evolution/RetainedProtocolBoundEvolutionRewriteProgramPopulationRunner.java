 ...
 * evaluator, combines the terminal roots with their complete genome and
 * program payloads, and then binds that retained state to the frozen evaluator
 * protocol. No VALIDATION or FINAL TEST input is accepted.</p>
 */
public final class RetainedProtocolBoundEvolutionRewriteProgramPopulationRunner {
    ...
    public ProtocolBoundRetainedEvolutionRewriteProgramPopulationRun run(
        ...
        return retain(run, registry, evaluator);
    }
    ...
    public ProtocolBoundRetainedEvolutionRewriteProgramPopulationRun resume(
        EvolutionRewriteProgramStudyPlan plan,
        EvolutionSplitManifest splitManifest,
        EvolutionRewriteProgramTrainSuite suite,
        List<EvolutionRewriteProgramCandidate> seeds,
