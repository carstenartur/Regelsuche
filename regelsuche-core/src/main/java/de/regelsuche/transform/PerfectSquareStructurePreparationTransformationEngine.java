...
/**
 * Opt-in engine that adds exact perfect-square exposure to all earlier
 * preparation paths.
 *
 * <p>The concrete difference-of-squares rule is replayed directly on the
 * retained prepared AST, preserving the grouping that a formatting round trip
 * could erase.</p>
 */
public final class PerfectSquareStructurePreparationTransformationEngine
    ...
    private final PerfectSquareStructurePreparationSolver solver;
    private final int maxPreparedCandidates;
    private final ExpressionParser parser = new ExpressionParser();
    private final ExpressionCanonicalizer canonicalizer =
        new ExpressionCanonicalizer();

    public PerfectSquareStructurePreparationTransformationEngine() {
    ...
    public PerfectSquareStructurePreparationTransformationEngine(
        ...
        PerfectSquareStructurePreparationSolver solver,
    ...
    private PerfectSquareStructurePreparationTransformationEngine(
        TransformationEngine baseEngine,
        TransformationEngine principalEngine,
    ...
    public static PerfectSquareStructurePreparationTransformationEngine
        ...
        return new PerfectSquareStructurePreparationTransformationEngine(rules);
    }

    public String solverId() {
        return PerfectSquareStructurePreparationSolver.SOLVER_ID;
    }
    ...
    public Execution transformWithEvidence(String expression) {
        ...
        for (PositionedNode positioned : positionedNodes(root)) {
            ...
            if (!isSubtraction(positioned.expression())) {
                continue;
            }
            PerfectSquareStructurePreparationSolver.PlanAttempt attempt =
    ...
    private Transformation preparedTransformation(
        ...
        PerfectSquareStructurePreparationSolver.PreparedApplication application =
    ...
    private static boolean isSubtraction(Expr expression) {
    ...
    public record PreparationObservation(
        ...
        public Optional<PerfectSquareStructurePreparationSolver.PreparedApplication>
                application() {
