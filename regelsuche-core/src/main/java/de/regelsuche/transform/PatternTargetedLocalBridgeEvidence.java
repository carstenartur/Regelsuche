...
public final class PatternTargetedLocalBridgeEvidence {
     ...
     * failures that occur before a transition exists are counted separately.
     */
    ...
    public record PreparedBridge(
        ...
        public PreparedBridge {
            ...
            certificateHash = requireHash(
                certificateHash,
                "certificateHash");
            int preparationPrimitiveSteps = preparationSteps.stream()
            ...
            if (preparationSteps.isEmpty()
                    ...
                    || !preparationSteps.getLast().expressionAfter().equals(
                        terminalPreparedExpression)
                    || preparationPrimitiveSteps > budget.maxPrimitiveSteps()
