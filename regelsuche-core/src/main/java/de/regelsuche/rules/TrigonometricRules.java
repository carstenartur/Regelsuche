...
public final class TrigonometricRules {
    ...
    public static List<RewriteRule> rules() {
        ...
        PatternExpr sinSquared = PatternExpr.op(
            BinaryOperator.POW, sinA, PatternExpr.num(2));
        PatternExpr cosSquared = PatternExpr.op(
            BinaryOperator.POW, cosA, PatternExpr.num(2));
        return List.of(
            ...
            new PatternRewriteRule(
                ...
                PatternExpr.fn("sin", PatternExpr.op(
                    BinaryOperator.MUL, PatternExpr.num(2), a)),
            ...
            new PatternRewriteRule(
                ...
                PatternExpr.fn("cos", PatternExpr.op(
                    BinaryOperator.MUL, PatternExpr.num(2), a)),
    ...
    static final class TanToSinOverCosRule
        ...
        public RewriteApplicabilitySchema applicabilitySchema() {
            ...
            return exactSource(
                ...
                RequiredAssumptionTemplate.nonZero(
