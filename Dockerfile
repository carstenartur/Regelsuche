...
COPY regelsuche-math-sympy/build.gradle ./regelsuche-math-sympy/build.gradle
...
COPY regelsuche-extension-api/build.gradle ./regelsuche-extension-api/build.gradle
COPY regelsuche-extension-runtime/build.gradle ./regelsuche-extension-runtime/build.gradle
...
COPY regelsuche-math-sympy ./regelsuche-math-sympy
...
COPY regelsuche-extension-api ./regelsuche-extension-api
COPY regelsuche-extension-runtime ./regelsuche-extension-runtime
